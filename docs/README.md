...
Step-by-step guides for Jal Studio, the embed widget, npm package, and API.

**In the app:** open [`/docs`](http://localhost:5173/docs) after `npm run dev`.

## Guides

| Guide | Description |
|-------|-------------|
| [Overview](./overview.md) | What Jal is and key concepts |
